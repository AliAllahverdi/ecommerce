<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="languageCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Language Options:</h6>
          <a class="collapse-item" href="{{route('languages.index')}}">Languages</a>
          <a class="collapse-item" href="{{route('languages.create')}}">Add Language</a>
        </div>
      </div>
    </li>
